...
static size_t wr(char * data, size_t sz, size_t n, void * ptr) {
...
int main(int argc, char ** argv) {
  ...
  char url[10240]; snprintf(url, sizeof(url), "https://%s/v1/chat/completions", argv[1]);
  ...
  char auth[10240];
  snprintf(auth, sizeof(auth), "Authorization: Bearer %s", argv[2]);
